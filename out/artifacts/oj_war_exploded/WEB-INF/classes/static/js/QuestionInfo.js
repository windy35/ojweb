...
layui.use(['form','laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
    ...
    table.render({
        ...
        ,cols: [[ //表头
            ...
            ,{field: 'questionid', title: '编号', width:80}
            ,{field: 'title', title: '标题', width:200, sort: true}
            ,{field: 'accepttime', title: '通过次数', width:150}
            ,{field: 'updatetime', title: '修改时间', width: 250,sort:true,
             templet:function (row){
                return DateFormat(1568206683000);}}
            ,{field: 'status', title: '状态', width: 80, sort: true}
            ,{fixed: 'right', width: 265, align:'center', title:'操作选项',toolbar: '#bar'}
        ]]
    });
